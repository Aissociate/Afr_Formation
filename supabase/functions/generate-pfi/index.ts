...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const prompt = renderTemplate(cfg.prompt_pfi, {
      ...
      situation_emploi: questionnaire.situation_emploi ?? lead.situation_pro ?? "Non renseigné",
      niveau_etudes: questionnaire.niveau_etudes ?? "Non renseigné",
      revenus_foyer: questionnaire.revenus_foyer ?? "Non renseigné",
      ...
      commentaires: questionnaire.commentaires ?? "Aucun",
